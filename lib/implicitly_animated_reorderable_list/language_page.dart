...
class _LanguagePageState extends State<LanguagePage>
  ...
  static const List<String> options = ['Shuffle','Test',];
  ...
  Widget _buildBox(Language item, double t) {
    ...
    final elevation = 8.0; //lerpDouble(0, 8, t)!;
    ...
    return Box(
      ...
      onTap: () async {
        final result = await Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Container(child: Text('LanguageSearchPage')),//const LanguageSearchPage(),
          ),
        );
        ...
        switch (value) {
          ...
          case 'Test':
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => Container(child: Center(child: Text('Test page'),),)//const TestPage(),
              ),
            );
            break;
        }
